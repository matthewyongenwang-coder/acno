    ...
    <div className="scan-graphic" ref={ref} aria-hidden>
      <svg viewBox="0 0 260 300" role="img">
        ...
        <g clipPath="url(#frame)">
          {/* soft abstract head + shoulders */}
          <circle cx="130" cy="128" r="52" fill="var(--bg-soft)" />
          <path
            d="M60 280 Q130 190 200 280 Z"
            fill="var(--bg-soft)"
          />
    ...
    <main id="about-root" className="about">
      <section className="about-hero">
        <div className="about-hero-text" data-reveal>
          ...
          <p className="lede">
            A dermatologist is expensive and slow to book, so most teens just
            guess, following whatever skincare trend is loudest online. A lot of
            that advice is wrong, and some of it makes acne worse. Acno is a free,
            private first answer that runs entirely on your own device.
          </p>
